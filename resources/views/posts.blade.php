<x-layout>
    ...
    <section class="bg-white dark:bg-gray-900 min-h-screen">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-1 mb-8">
            <h2 class="py-8 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Kumpulan Artikel</h2>
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/posts/{{ $post['slug'] }}" class="inline-flex items-center font-medium text-blue-600 dark:text-primary-500 hover:underline">
                            Read more
